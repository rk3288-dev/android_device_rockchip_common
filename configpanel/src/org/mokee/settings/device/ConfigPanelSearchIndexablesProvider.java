...
public class ConfigPanelSearchIndexablesProvider extends SearchIndexablesProvider {
    ...
    public static final int SEARCH_IDX_VIDEO_PANEL = 0;

    private static SearchIndexableResource[] INDEXABLE_RES = new SearchIndexableResource[]{
            new SearchIndexableResource(1, R.xml.video_panel,
                    VideoSettings.class.getName(),
    ...
    public Cursor queryXmlResources(String[] projection) {
        ...
        if (Startup.hasVideoProcs() /* show button panel */) {
            cursor.addRow(generateResourceRef(INDEXABLE_RES[SEARCH_IDX_VIDEO_PANEL]));
        }
        return cursor;
    }
