...
public class NodePreferenceActivity extends PreferenceActivity
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        node = Constants.sBooleanNodePreferenceMap.get(preference.getKey());
        ...
        if (!TextUtils.isEmpty(node)) {
            ...
            android.util.Log.d("ConfigPanel", "Write to node " + node + ", value " + value);
            FileUtils.writeLine(node, value + "\n");
            android.util.Log.d("ConfigPanel", "Wrote node");
            return true;
        }
